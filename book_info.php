...
<div id = "bar-top">
	...
	<div id = "main">
		<div id = "content">
			...
			<div id = "book-star">★★★★★</div>

			<div id = "book-user">

				<?php echo $withstudyclass -> getBookUserCountById($bookid);?> 명의 사용자가 사용중
			...
			<div id = "book-content">
				...
				<?php echo $withstudyclass -> getBigIndexById($bookid);  ?>

			</div>

			<div id ="add-button">
				<?php echo "<a href = '/withstudy/add_book_controller.php?bookid=". $bookid ." '> 등록</a>";  ?>


				<!-- <a href = '/withstudy/add_book_controller.php?bookid='+ <?php echo $bookid; ?> + ' '> -->
				</a>
